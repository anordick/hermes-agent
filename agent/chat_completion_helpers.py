...
def interruptible_api_call(agent, api_kwargs: dict):
    ...
    if _est_tokens_for_codex_watchdog > 100_000:
        _codex_idle_timeout_default = 1800.0
    elif _est_tokens_for_codex_watchdog > 50_000:
        _codex_idle_timeout_default = 1200.0
    ...
    # had a chance to emit its first SSE event. Default to 1200s — long enough to
    ...
    _ttfb_timeout = _env_float("HERMES_CODEX_TTFB_TIMEOUT_SECONDS", 1200.0)
    if _ttfb_timeout <= 0:
        _ttfb_enabled = False
        ...
        if (
            ...
            _ttfb_cap = _env_float("HERMES_CODEX_TTFB_MAX_SECONDS", 1200.0)
